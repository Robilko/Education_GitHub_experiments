...
class SearchPresenterTest {
    ...
    fun searchGitHub_Test() {
        val searchQuery = TEST_SOME_SEARCH_QUERY_ALGOL
        //Запускаем код, функционал которого хотим протестировать
        presenter.searchGitHub(TEST_SOME_SEARCH_QUERY_ALGOL)
    ...
    fun handleGitHubResponse_Failure() {
        ...
        verify(viewContract, times(1))
            .displayError(TEST_NULL_RESPONSE_ERROR)
    }
    ...
    fun handleGitHubResponse_ResponseFailure_ViewContractMethodOrder() {
        ...
        inOrder.verify(viewContract).displayError(TEST_NULL_RESPONSE_ERROR)
    }
    ...
    fun handleGitHubResponse_EmptyResponse() {
        ...
        verify(viewContract, times(1))
            .displayError(TEST_NULL_RESULT_OR_NULL_COUNT_ERROR)
    }
